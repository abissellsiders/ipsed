...
#' \item DATA: Charities Aid Foundation World Giving Index 2022: <https://www.cafonline.org/about-us/publications/2022-publications/caf-world-giving-index-2022>
#' \item DATA: Charities Aid Foundation World Giving Index 2021: <https://www.cafonline.org/about-us/publications/2021-publications/caf-world-giving-index-2021>
...
#' @format A data table with many rows and four key categories:
#' \describe{
#' \item{overall}{simple mean of money, time, stranger}
#' \item{money}{proportion of respondents answering yes to: "Have you done any of the following in the past month? Donated money to a charity?"}
#' \item{time}{proportion of respondents answering yes to: "Have you done any of the following in the past month? Volunteered your time to an organisation?"}
#' \item{stranger}{proportion of respondents answering yes to: "Have you done any of the following in the past month? Helped a stranger, or someone you didn't know who needed help."}
#' }
"charity_wgi"

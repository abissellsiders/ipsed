...
#'
#' For code see `/data-raw/polity.r` in source.
#' @references
...
#' }
#' @source
#' * Wiki: \url{https://en.wikipedia.org/wiki/Polity_data_series}
#' * Page: \url{https://www.systemicpeace.org/inscrdata.html}
#' * Data: \url{http://www.systemicpeace.org/inscr/p5v2018.xls}
#' * Documentation: \url{http://www.systemicpeace.org/inscr/p5manualv2018.pdf}
"polity"
